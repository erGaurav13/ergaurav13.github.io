...
import myImage from "../Resources/Images/Gaurav-Kumar.png";
      ...
      <Container>
        <div className="aboutBox">
          <div className="about_leftBox">
            <h1 id="user-detail-name">Hi, I'm Gaurav Kumar.</h1>
            <Typical
              className="typical"
              loop={Infinity}
              steps={[
      ...
      <AboutMeWrapper data-aos="fade-right">
        <div className="aboutSection">
          <div className="left">
            ...
            <p></p>
            <p>
              Email: <span>gauravgk1313@gmail.com</span>
            </p>
            <p>
          ...
          <div className="right">
            ...
            Hello stranger! 👋, my name is Gaurav Kumar
            and I am a Full Stack Web Developer, passionate 
